...
/** 
 * This class represents the primary key of the off_days table.
 */
public class OffDaysPk implements Serializable
{
	protected int id;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof OffDaysPk)) {
			return false;
		}
		
		final OffDaysPk _cast = (OffDaysPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "org.nic.epanjeeyan.dto.OffDaysPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}

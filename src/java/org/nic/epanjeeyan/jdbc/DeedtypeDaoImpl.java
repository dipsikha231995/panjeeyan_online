...
public class DeedtypeDaoImpl extends AbstractDAO implements DeedtypeDao
{
	/** 
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT code, section FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( code, section ) VALUES ( ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET code = ?, section = ? WHERE code = ?";
	...
	/** 
	 * Index of column section
	 */
	protected static final int COLUMN_SECTION = 2;
	...
	public DeedtypePk insert(Deedtype dto) throws DeedtypeDaoException
	{
		...
		try {
			...
			stmt.setString( index++, dto.getSection() );
			...
			_e.printStackTrace();
			throw new DeedtypeDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	{
		Deedtype ret[] = findByDynamicSelect( SQL_SELECT + " WHERE code = ?", new Object[] {  new Integer(code) } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE section = ? ORDER BY section", new Object[] { section } );
	}

	/**
	 * Method 'DeedtypeDaoImpl'
	 * 
	 */
	public DeedtypeDaoImpl()
	{
	}
	 ...
	 * @param userConn
	 */
	public DeedtypeDaoImpl(final java.sql.Connection userConn)
	{
	 ...
	 */
	protected Deedtype fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			Deedtype dto = new Deedtype();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected Deedtype[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		Deedtype ret[] = new Deedtype[ resultList.size() ];
	 ...
	 */
	protected void populateDto(Deedtype dto, ResultSet rs) throws SQLException
	{
		dto.setCode( rs.getInt( COLUMN_CODE ) );
		dto.setSection( rs.getString( COLUMN_SECTION ) );
	}

	/** 
	 * Resets the modified attributes in the DTO
	 */
	protected void reset(Deedtype dto)
	{
	}
	...
	public Deedtype[] findByDynamicWhere(String sql, Object[] sqlParams) throws DeedtypeDaoException
	{
		...
		try {
         ...
         public Integer customDynamicSelect2(String sql, Object[] sqlParams) throws DeedtypeDaoException           {
        // declare variables
        final boolean isConnSupplied = (userConn != null);
        Connection conn = null;
        PreparedStatement stmt = null;
